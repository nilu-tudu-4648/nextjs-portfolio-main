      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#home" className="text-light-300 hover:text-primary-500 transition-colors text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#about" className="text-light-300 hover:text-primary-500 transition-colors text-sm">
                  About
                </Link>
              </li>
              <li>
                <Link href="#projects" className="text-light-300 hover:text-primary-500 transition-colors text-sm">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="#contact" className="text-light-300 hover:text-primary-500 transition-colors text-sm">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-light-300 text-sm">Web Development</li>
              <li className="text-light-300 text-sm">Mobile Development</li>
              <li className="text-light-300 text-sm">UI/UX Design</li>
              <li className="text-light-300 text-sm">Consulting</li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-light-300 text-sm flex items-start">
                ...
                <span>tudunilesh3@gmail.com</span>
              </li>
              <li className="text-light-300 text-sm flex items-start">
                <svg className="w-5 h-5 text-primary-500 mr-2 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+91 9155186701</span>
              </li>
              <li className="text-light-300 text-sm flex items-start">
                <svg className="w-5 h-5 text-primary-500 mr-2 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-dark-200 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-light-300 text-sm mb-4 md:mb-0">
            © {currentYear} WebUmul Studios. All rights reserved.
          </p>
